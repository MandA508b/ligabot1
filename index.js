...
bot.action('fix_advertisement', async (ctx)=> {
    try{
        ...
        advertisement = await advertisementService.switchStatusStage(advertisement._id, 'fixed', chatId)
...
bot.action('reserve_advertisement', async (ctx)=> {
    try{
        ...
        const chat = await chatService.getByNumberAndAdvertisementId(numberChat, advertisement._id)
        advertisement = await advertisementService.switchStatusStage(advertisement._id, 'reserved', chatId)
