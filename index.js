...
app.use(cors({
    credentials: true,
    origin: ['https://chatclient.ligabot.pp.ua','https://admin.ligabot.pp.ua','http://localhost:3000','https://heroic-profiterole-cc695c.netlify.app', 'https://main--voluble-pegasus-6a9597.netlify.app','https://neon-kulfi-303418.netlify.app']
}))
app.use('/', router)
